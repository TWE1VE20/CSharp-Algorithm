namespace _07._HashTable
{
    internal class Program
    {
        ...
        // 
        // 나눗셈법   예시 : 132031 → (132031 % 1000) = 31번지
        // 자리수접기 예시 : "hash" → h(104) + a(97) + s(115) + h(104) = 420번지
        ...
        // 단 삭제의 경우 해쉬내를 비우는것이 아닌 null값을 넣는것으로 처리하기에
        // 삽입 삭제가 빈번하면 null값이 많아지며 점점 비효율적이 된다.
        //
        //   [0]   [1]   [2]        [81]  [82]      [191] [192] [193]
        // ┌─────┬─────┬─────┬─  ─┬─────┬─────┬─  ─┬─────┬─────┬─────┐
        // │     │     │     │....│  X  │ 660 │....│     │     │     │
        ...
        // Entry.State.Deleted 상태로 전환하여 더이상 이곳에 데이터를 넣으면
        // 안된다는 상태로 만들어 들어가지 못하도록 한다.
